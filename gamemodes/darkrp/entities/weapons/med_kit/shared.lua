...
function SWEP:PrimaryAttack()
    ...
    if found then
        ...
        self:EmitSound("buttons/blip1.wav", 50, found:Health() / found:GetMaxHealth() * 100, 1, CHAN_AUTO)
    end
end
...
function SWEP:SecondaryAttack()
    ...
    if ply:Health() < maxhealth then
        ...
        self:EmitSound("buttons/blip1.wav", 50, ply:Health() / ply:GetMaxHealth() * 100, 1, CHAN_AUTO)
    end
end
