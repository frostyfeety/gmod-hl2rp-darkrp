...
SWEP.Sound = Sound("ambient/materials/door_hit1.wav")
...
local function ramProp(ply, trace, ent)
    ...
    if ent:GetClass() == "func_door" then return false end
...
function SWEP:PrimaryAttack()
    ...
    if trace.Entity:GetClass() == "func_door" then return end
    if trace.Entity:GetClass() == "func_movelinear" then return end
