...
function PANEL:Paint(w,h)
	draw.RoundedBox(0,0,0,w,h,IGS.col.HIGHLIGHTING) -- outline

	if !self.active then
		draw.RoundedBox(0,1,1,w - 2,h - 2,IGS.col.PASSIVE_SELECTIONS) -- bg TODO изменить, сделав как-то прозрачным
	end
end
