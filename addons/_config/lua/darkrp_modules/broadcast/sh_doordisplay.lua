local TitleColor = Color( 200, 200, 200, 255 )
local TitleOutlineColor = Color( 0, 0, 0, 255 )

local OwnerColor = Color( 200, 200, 200, 255 )
local OwnerOutlineColor = Color( 0, 0, 0, 200 )

local CoownerColor = Color( 155, 155, 155, 255 )
local CoownerOutlineColor = Color( 0, 0, 0, 200 )

local AllowedGroupsColor = Color( 200, 200, 200, 255 )
local AllowedGroupsOutlineColor = Color( 0, 0, 0, 200 )

local PurchaseColor = Color( 200, 200, 200, 255 )
...
surface.CreateFont( "rp_door_display_title", {
	font = "Roboto",
	size = 33,
	weight = 1500, 
	antialias = true, 
...
surface.CreateFont("rp_door_display_small", {
	font = "Roboto",
	size = 45,
	weight = 2000,
	antialias = true,
...
hook.Add( "HUDDrawDoorData", "rp_door_override_hud", function( door )
...
hook.Add( "PostDrawTranslucentRenderables", "rp_doordisplay_room", function()
