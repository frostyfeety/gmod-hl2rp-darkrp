...
function ENT:Use(activator)
	...
	activator:SendLua('local phrases = {"Не бойся, это круто", "Иногда страшновато"} chat.AddText(Color(155,155,155), "Алексей: ", Color(255,255,255), phrases[math.random(1,#phrases)] )')
end