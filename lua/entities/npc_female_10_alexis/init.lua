...
local ent = ents.Create( "npc_female_10_alexis" )
...
self.npc:SetModel("models/tnb/citizens/female_10.mdl")
...
if self.npc:GetBodygroup(1) == 13 and self.npc:GetBodygroup(2) == 2 and self.npc:GetBodygroup(3) == 1 and self.npc:GetBodygroup(4) == 1 then
