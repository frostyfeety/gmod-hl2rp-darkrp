...
local ent = ents.Create( "npc_tnb_female_metrocop" )
...
self.npc:SetModel("models/tnb/combine/metrocop_female.mdl")
...
self.npc:SetSkin( math.random(0,4))
...
if npc:GetActiveWeapon() == NULL then return false end
if self.NoEnemy == true and npc:GetActiveWeapon():GetClass() == "weapon_smg1" and self.npc.Iambeingcommanded == false and !npc:IsCurrentSchedule( SCHED_IDLE_WANDER ) then
