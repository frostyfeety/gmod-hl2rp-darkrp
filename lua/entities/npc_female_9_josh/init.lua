...
local ent = ents.Create( "npc_female_9_josh" )
...
self.npc:SetModel("models/tnb/citizens/female_09.mdl")
...
elseif self.npc:GetBodygroup(1) == 8 or self.npc:GetBodygroup(1) == 9 then
...
if self.npc:GetBodygroup(1) == 14 and self.npc:GetBodygroup(2) == 2 and self.npc:GetBodygroup(3) == 1 and self.npc:GetBodygroup(4) == 1 then
self.npc:SetHealth(200)
self.npc:SetMaxHealth(200) 
self.npc:SetName("Josh")
